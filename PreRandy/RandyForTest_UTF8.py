...
def createTime():
    ...
    useEnd = grantEnd = time.strftime('%Y-%m-%d %H:%M:%S', time.localtime(time.time() + 10*24 * 60 * 60))
...
def createCouponTime():
    ...
    useEnd = time.strftime('%Y-%m-%d', time.localtime(time.time() + 10*24 * 60 * 60))
    grantEnd = time.strftime('%Y-%m-%d %H:%M:%S', time.localtime(time.time() + 10* 24 * 60 * 60))
    return grantStart, grantEnd, useStart, useEnd
