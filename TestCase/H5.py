...
class StoreActivity(SuperUnit):
    ...
    def test_008(self):
        ...
        current_money=getFinalMoney(self.driver.page_source)
        print("购物车，物品价格150，3件，各活动赠物品后打8折")
        print(self._testMethodName,current_money)
        # TODO 需要加入金额断言
    ...
    def test_009(self):
        ...
        current_money=getFinalMoney(self.driver.page_source)
        print("购物车，物品价格100，3件，各活动满减后打8折")
        print(self._testMethodName,current_money)
        # TODO 需要加入金额断言
